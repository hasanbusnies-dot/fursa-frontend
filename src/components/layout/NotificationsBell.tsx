                  ...
                  <li key={n.id}>
                    ...
                    >
                      ...
                      <span className="flex-1 min-w-0">
                        ...
                        <span className="block text-xs text-gray-500 line-clamp-2 leading-relaxed">{n.content}</span>
                        <span className="block text-[11px] text-gray-400 mt-1">{timeAgoAr(n.createdAt)}</span>
                      </span>
